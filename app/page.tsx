    ...
    <main>
      ...
      <header className="site-header">
        <a className="brand" href="#top" aria-label="Waterhen Lake First Nation home">
          <img className="brand-mark" src="/waterhen-lake-emblem.jpg" alt="Waterhen Lake First Nation emblem" />
      ...
      <footer>
        <div className="footer-brand"><img className="brand-mark" src="/waterhen-lake-emblem.jpg" alt="" /><strong>Waterhen Lake First Nation</strong></div>
